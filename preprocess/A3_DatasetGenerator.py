...
class A3_DatasetGenerator:
    ...
    def preproc_datapoints(move_file):
        ...
        with open(move_file, 'r') as f:
            ...
            for line in lines:
                # line e.g. | e2e4 c7c6 d2d4 d7d5 b1c3 d5e4 c3e4 b8d7 e4g5 d7f6 f1c4 g8h6 c2c3 g7g6 g1f3 f8g7 h2h4 f6d5 h4h5 f7f6 g5e4
                # --- White Datapoint ---
                #  self_attn: [start] e2e4 d2d4 b1b3 c3e4 e4g5 f1c4 c2c3 g1f3 h2h4 h4h5 g5e4
                # cross_attn: [black] c7c6 d7d5 d5e4 b8d7 d7f6 g8h6 g7g6 f8g7 f6d5 f7f6
                # --- Black Datapoint ---
                #  self_attn: [start] c7c6 d7d5 d5e4 b8d7 d7f6 g8h6 g7g6 f8g7 f6d5 f7f6
                # cross_attn: e2e4    d2d4 b1b3 c3e4 e4g5 f1c4 c2c3 g1f3 h2h4 h4h5 g5e4
                ...
                # If last move is either [white] or [black], remove from the sequence entirely
                if moves[-1] == '[white]' or moves[-1] == '[black]':
                    moves = moves[:-1]
...
if __name__ == '__main__':
    ...
    generator = A3_DatasetGenerator(curr_dataset)
