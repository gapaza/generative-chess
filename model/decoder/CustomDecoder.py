...
@keras_nlp_export("keras_nlp.layers.CustomDecoder")
class CustomDecoder(keras.layers.Layer):
    ...
    decoder = keras_nlp.layers.CustomDecoder(
    ...
    def call(
        ...
        """Forward pass of the CustomDecoder.
        ...
        if not has_cross_attention and has_encoder_sequence:
            raise ValueError(
                ...
                "`keras_nlp.layers.CustomDecoder` should not change. "
        ...
        if has_cross_attention and (
            ...
            raise ValueError(
                "When calling `keras_nlp.layers.CustomDecoder` with "
        ...
        if has_cross_attention:
            ...
            # print('\n\n\nEncoder Sequence:', encoder_sequence)
            # print('\n\n\nEncoder Padding Mask:', encoder_padding_mask)
