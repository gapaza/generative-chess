...
class CachedMultiHeadAttention(keras.layers.MultiHeadAttention):
    ...
    def call(
        ...
        # We want the attention score output to be averaged over the heads
        attention_scores = ops.mean(
            attention_scores, axis=1, keepdims=False
        )
...
if __name__ == '__main__':
    ...
    print(outputs.shape)  # Should print (2, 10, 64)
    print(attn.shape)  # Should print (2, 4, 10, 10)
