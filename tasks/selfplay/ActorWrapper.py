...
class ActorWrapper:
    ...
    def calc_reward(self, board, uci_move, prev_score, engine):
        ...
        if move not in board.legal_moves:
            self.illegal_moves += 1
            print('--> Illegal move:', uci_move, 'board:', board.fen(), 'legal moves:', board.legal_moves)
            return True, illegal_move_reward, prev_score
    ...
    def train_ppo(self, games, white_turn):
        ...
        print(model_color, 'avg reward', np.mean(self.flat_rewards), 'kl', kl, 'entr', entr, 'loss', loss, 'policy_loss', policy_loss, 'checkmates', self.checkmates, 'illegal_moves', self.illegal_moves, 'policy_update_itr', policy_update_itr)
    ...
    def train_actor_critic(
        ...
        with tf.GradientTape() as tape:
            ...
            loss += critic_loss_coef * value_loss
